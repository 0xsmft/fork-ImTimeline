...
struct Color
{
	...
	static constexpr ImU32 Red = IM_COL32( 255, 0, 0, 255 );
	static constexpr ImU32 Green = IM_COL32( 0, 255, 0, 255 );
	static constexpr ImU32 Blue = IM_COL32( 0, 0, 255, 255 );
	static constexpr ImU32 Yellow = IM_COL32( 255, 255, 0, 255 );
	static constexpr ImU32 Cyan = IM_COL32( 0, 255, 255, 255 );
	static constexpr ImU32 Magenta = IM_COL32( 255, 0, 255, 255 );
	static constexpr ImU32 Gray = IM_COL32( 128, 128, 128, 255 );
	static constexpr ImU32 DarkGray = IM_COL32( 64, 64, 64, 255 );
	static constexpr ImU32 Orange = IM_COL32( 255, 165, 0, 255 );
	static constexpr ImU32 Purple = IM_COL32( 128, 0, 128, 255 );
	static constexpr ImU32 Pink = IM_COL32( 255, 192, 203, 255 );
	static constexpr ImU32 Brown = IM_COL32( 165, 42, 42, 255 );
	static constexpr ImU32 Lime = IM_COL32( 50, 205, 50, 255 );

	static constexpr ImU32 LightRed = IM_COL32( 140, 90, 110, 255 );
	static constexpr ImU32 LightBlue = IM_COL32( 76, 111, 155, 255 );
	static constexpr ImU32 LightGreen = IM_COL32( 128, 150, 90, 255 );
	static constexpr ImU32 LightGray = IM_COL32( 160, 160, 160, 255 );
};

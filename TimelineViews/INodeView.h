...
public:
	...
	virtual void DrawNodeView( const ImRect& rArea, const TimelineSection& rTimeline, ImTimeline::Timeline* pContext ) {};
	virtual void DefaultNodeDraw( const ImRect& rArea, const TimelineNode& rNode, ImTimeline::Timeline* pContext ) {};
